...
public SignalPlot (double[] signal, double yMin, double yMax) {
   this(signal, 0, 0, signal.length, yMin, yMax); }

public SignalPlot (double[] signal, int signalOffset, double xMin, double xMax, double yMin, double yMax) {
...
public SignalPlotFunction (double[] signal, int signalOffset) {
   this.signal = signal;
